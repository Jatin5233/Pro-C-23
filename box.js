class Box{
    ...
    this.body1=Bodies.rectangle(width/2,640,200,20,options);
    this.width1=200;
    this.height1=20;
    
    this.body2=Bodies.rectangle(300,600,20,100,options);
    this.width2=20;
    this.height2=100;
    
    this.body3=Bodies.rectangle(500,600,20,100,options);
    this.width3=20;
    this.height3=100;
